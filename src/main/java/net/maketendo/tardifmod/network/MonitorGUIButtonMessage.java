...
import net.maketendo.tardifmod.procedures.ChamelionUpProcedure;
import net.maketendo.tardifmod.procedures.ChamelionDownProcedure;
...
public class MonitorGUIButtonMessage {
	...
	public MonitorGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 1) {
			...
			ChamelionDownProcedure.execute(world);
		}
		if (buttonID == 2) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TardifModMod.addNetworkMessage(MonitorGUIButtonMessage.class, MonitorGUIButtonMessage::buffer, MonitorGUIButtonMessage::new, MonitorGUIButtonMessage::handler);
	}
}
