...
public class ModelCustomModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("tardif_mod", "model_custom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Chestunit = body.addOrReplaceChild("Chestunit", CubeListBuilder.create().texOffs(91, 85).addBox(-1.0F, -23.0F, -5.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(99, 101)
				.addBox(1.0F, -23.0F, -5.0F, 3.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(51, 38).addBox(-4.0F, -23.0F, -5.0F, 3.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition Handelbars = helmet.addOrReplaceChild("Handelbars",
				CubeListBuilder.create().texOffs(10, 18).addBox(-7.0F, -28.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 18).addBox(4.0F, -28.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(58, 79)
						...
						.addBox(-1.0F, -33.0F, 3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-1.0F, -35.0F, 5.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(43, 107)
						.addBox(-2.5F, -14.0F, -5.0F, 5.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(47, 82).addBox(-2.5F, -14.0F, -4.0F, 5.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		PartDefinition cube_r2 = Handelbars.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(92, 122).addBox(-4.5F, -4.5F, -8.5F, 9.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -4.0126F, 1.743F, -0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r3 = Handelbars.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(68, 123).addBox(-4.5F, -2.5F, -0.5F, 9.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -13.0F, -4.5F, 0.3927F, 0.0F, 0.0F));
		PartDefinition brim = head.addOrReplaceChild("brim", CubeListBuilder.create().texOffs(30, 47).addBox(-5.0F, -5.0F, -7.0F, 10.0F, 10.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F));
		...
		PartDefinition arms_r1 = arms.addOrReplaceChild("arms_r1", CubeListBuilder.create().texOffs(0, 115).mirror().addBox(-2.5F, -0.5F, -2.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-7.0F, -2.1213F, -2.1213F, 0.7854F, 0.0F, 0.0F));
		PartDefinition arms_r2 = arms.addOrReplaceChild("arms_r2", CubeListBuilder.create().texOffs(44, 22).addBox(-8.0F, -24.0F, -0.5F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition arms_r3 = arm2.addOrReplaceChild("arms_r3", CubeListBuilder.create().texOffs(0, 115).mirror().addBox(-2.5F, -0.5F, -2.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(7.0F, -24.1213F, -2.1213F, 0.7854F, 0.0F, 0.0F));
		PartDefinition arms_r4 = arm2.addOrReplaceChild("arms_r4", CubeListBuilder.create().texOffs(44, 22).mirror().addBox(-2.0F, -6.0F, -2.5F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
