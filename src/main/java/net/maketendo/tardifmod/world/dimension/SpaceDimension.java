...
import net.maketendo.tardifmod.procedures.SpacePlayerEntersDimensionProcedure;
...
public class SpaceDimension {
	...
	public static class DimensionSpecialEffectsHandler {
		...
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("tardif_mod:space"), customEffect);
		}
	}
	...
	public static void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == ResourceKey.create(Registries.DIMENSION, new ResourceLocation("tardif_mod:space"))) {
