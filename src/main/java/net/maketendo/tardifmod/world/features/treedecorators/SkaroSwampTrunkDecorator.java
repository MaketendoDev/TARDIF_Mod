...
public class SkaroSwampTrunkDecorator extends TrunkVineDecorator {
	public static Codec<SkaroSwampTrunkDecorator> CODEC = Codec.unit(SkaroSwampTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("skaro_swamp_tree_trunk_decorator", DECORATOR_TYPE));
	}
