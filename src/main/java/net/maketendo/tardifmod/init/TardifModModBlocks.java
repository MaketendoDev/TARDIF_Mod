...
import net.maketendo.tardifmod.block.WeakDrystonePlanksBlock;
...
import net.maketendo.tardifmod.block.PetrifiedStoneBlock;
import net.maketendo.tardifmod.block.PetrifiedGrassBlockBlock;
import net.maketendo.tardifmod.block.PetrifiedGrassBlock;
...
import net.maketendo.tardifmod.block.DryStonePlanksBlock;
...
public class TardifModModBlocks {
	...
	public static final RegistryObject<Block> PETRIFIED_GRASS_BLOCK = REGISTRY.register("petrified_grass_block", () -> new PetrifiedGrassBlockBlock());
	public static final RegistryObject<Block> PETRIFIED_GRASS = REGISTRY.register("petrified_grass", () -> new PetrifiedGrassBlock());
	public static final RegistryObject<Block> RAIDIATED_SAND = REGISTRY.register("raidiated_sand", () -> new RaidiatedSandBlock());
	public static final RegistryObject<Block> DRY_STONE_PLANKS = REGISTRY.register("dry_stone_planks", () -> new DryStonePlanksBlock());
