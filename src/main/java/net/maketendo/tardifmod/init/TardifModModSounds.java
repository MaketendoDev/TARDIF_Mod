...
public class TardifModModSounds {
	...
	public static final RegistryObject<SoundEvent> VM_TELEPORT = REGISTRY.register("vm_teleport", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("tardif_mod", "vm_teleport")));
