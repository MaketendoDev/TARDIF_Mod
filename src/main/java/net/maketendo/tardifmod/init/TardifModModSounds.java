...
public class TardifModModSounds {
	...
	public static final RegistryObject<SoundEvent> DENIED_TARDIS_TAKE_OFF = REGISTRY.register("denied_tardis_take_off", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("tardif_mod", "denied_tardis_take_off")));
}
