...
public class DalekEntity extends Monster implements RangedAttackMob {
	public DalekEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TardifModModEntities.DALEK.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(TardifModModEntities.DALEK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
