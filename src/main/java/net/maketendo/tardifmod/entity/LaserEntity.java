...
public class LaserEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(TardifModModItems.LASER_ITEM.get());

	public LaserEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(TardifModModEntities.LASER.get(), world);
	}
	...
	public static LaserEntity shoot(LivingEntity entity, LivingEntity target) {
		LaserEntity entityarrow = new LaserEntity(TardifModModEntities.LASER.get(), entity, entity.level());
