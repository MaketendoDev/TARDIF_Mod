...
public class Modelweeping_angel_two<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "weeping_angel_two"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition arms = body.addOrReplaceChild("arms",
				CubeListBuilder.create().texOffs(54, 54)
						.addBox(-8.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(54, 54)
						.mirror().addBox(4.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(54, 54).mirror().addBox(4.0F, 6.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(54, 54).mirror()
						.addBox(-8.0F, 6.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
