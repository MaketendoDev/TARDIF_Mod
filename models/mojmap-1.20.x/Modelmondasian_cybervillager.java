...
public class Modelmondasian_cybervillager<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mondasian_cybervillager"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition brim = partdefinition
		...
		PartDefinition arms_r1 = arm2.addOrReplaceChild("arms_r1",
		...
		PartDefinition arms_r2 = arm2.addOrReplaceChild("arms_r2",
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 38)
						.addBox(-4.0F, -24.0F, -3.0F, 8.0F, 18.0F, 6.0F, new CubeDeformation(0.5F)).texOffs(16, 20)
						.addBox(-4.0F, -24.0F, -3.0F, 8.0F, 12.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Chestunit = partdefinition.addOrReplaceChild("Chestunit",
		...
		PartDefinition Handelbars = helmet.addOrReplaceChild("Handelbars",
				CubeListBuilder.create().texOffs(10, 18)
						...
						.addBox(-1.0F, -35.0F, 5.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		...
		PartDefinition arms_r3 = arms.addOrReplaceChild("arms_r3",
				CubeListBuilder.create().texOffs(0, 115).mirror()
						.addBox(-2.5F, -0.5F, -2.0F, 5.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-7.0F, -2.1213F, -2.1213F, 0.7854F, 0.0F, 0.0F));

		PartDefinition arms_r4 = arms.addOrReplaceChild("arms_r4",
