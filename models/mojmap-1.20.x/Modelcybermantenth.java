...
public class Modelcybermantenth<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cybermantenth"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(32, 48)
						...
						.addBox(-1.5F, -3.0F, -2.5F, 4.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(90, 80)
						.addBox(-5.5F, 9.0F, -2.5F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(90, 80)
						.addBox(-9.5F, 9.0F, -2.5F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(54, 16)
						.addBox(-12.5F, -3.0F, -2.5F, 4.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(48, 48)
